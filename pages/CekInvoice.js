  ...
  return (
    <div>
      <div className='md:w-5/12 my-9 mx-5 shadow-2xl md:mx-auto dark:border-gray-300 dark:border rounded-md'>
        <h1 className='p-3 text-white text-lg mb-2 dark:border-gray-300 border-b border-gray-800 dark:text-black'>Cek Invoice</h1>
      <div>
          <h1 className='px-3 text-white text-md pt-3 mb-1 dark:text-black'>Invoice Number:</h1>
