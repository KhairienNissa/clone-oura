...
import Cobadua from "../new/cobadua";
  ...
  return (
    <>
      <div className="shadow-2xl rounded-md border border-gray-800 dark:border-gray-300 mt-3 mx-3 my-3 ">
        <h1 className="text-white text-lg  rounded-t-md dark:text-black p-3 dark:border-gray-300 border-b border-gray-700 dark:bg-[#F0F1F2]">Pilih Metode Pembayaran</h1>
