        ...
        <Dialog as="div" className="relative z-20" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-scroll">
            <div className="flex items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel
                  className="dark:bg-white bg-[#212529] w-full md:w-8/12 h-[550px] transform overflow-y-scroll rounded-md p-4 text-left align-middle shadow-3xl transition-all"
                >
                  <div className="border-2 border-abu-abu rounded-sm">
                    ...
                    <div className="mt-4 p-3 ">
                      <Image src={Iklan} alt="iklan" width='1000px' height='900px'/>
                  ...
                  <div className="py-3 flex">
                    <div className="flex justify-start">
                      ...
                      <div className="text-white text-xs -mt-1 px-2  dark:text-black">
